...
function OrderScreen({ match }) {
    ...
    // ATog_p4Ya4FDIJDzzldQf3SzJ3CwW42_BwrEXY-u9lnQeGk6JWSQ8gNqok6qGtrq-nPGnWU4HbKMEVKS
    ...
    const addPayPalScript = () => {
        ...
        script.src = 'https://www.paypal.com/sdk/js?client-id=ATog_p4Ya4FDIJDzzldQf3SzJ3CwW42_BwrEXY-u9lnQeGk6JWSQ8gNqok6qGtrq-nPGnWU4HbKMEVKS'
        script.async = true
        script.onload = () => {
            setSdkReady(true)
        }
